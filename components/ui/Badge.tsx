  ...
  return (
    <div
      className={cn(
        ...
        {
          "border-transparent bg-primary-600 text-white shadow hover:bg-primary-600/80": variant === "default",
          "border-transparent bg-slate-200 text-slate-900 hover:bg-slate-200/80": variant === "secondary",
